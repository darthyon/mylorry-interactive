// host-shell.jsx — Host portal shell for Organization Management.
// Re-exports from shared-shell.jsx; defaults the active nav item to Organisation.
...
function HostSidebar({ active = "organisation" }) {
