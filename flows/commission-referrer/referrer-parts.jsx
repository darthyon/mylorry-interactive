// referrer-parts.jsx — Shared building blocks for the Referrer Commission page:
// KPI hero, table cell renderers, and the transaction drill modal.
// Composed by referrer-app.jsx + referrer-statements.jsx via the window.* exports below.
const AC = window.RC;
