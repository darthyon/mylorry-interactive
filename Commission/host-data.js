...
(function () {
  ...
  const AGENTS = [
    { id:"AG-0042", num:1,  referrer:false, name:"Kenneth Wang",               mobile:"0123456789", email:"kenneth@mylorry.ai",       ic:"820101-05-1234", bankName:"Maybank",      accNo:"112361629821", accName:"Kenneth Wang",               role:"Internal Sales Agent", joined:"Aug 2024", status:"active",      accountStatus:"active",     spCount:6,  volume:213400, commission:2347.00, kpiMult:100, kpiTarget:200000, kpiPct:106.7, kpiPhase:"active"   },
    { id:"AG-0019", num:2,  referrer:true,  name:"Ahmad Faris",                mobile:"0133029991", email:"ahmad.faris@gmail.com",    ic:"780515-08-6473", bankName:"CIMB",         accNo:"6364296502",   accName:"Ahmad Faris",                role:"Senior Agent",         joined:"Jan 2022", status:"active",      accountStatus:"active",     spCount:11, volume:245600, commission:2890.00, kpiMult:100, kpiTarget:220000, kpiPct:111.6, kpiPhase:"active"   },
    { id:"AG-0031", num:3,  referrer:false, name:"Priya Nair",                 mobile:"0176699017", email:"priya.nair@gmail.com",     ic:"890322-10-5033", bankName:"Maybank",      accNo:"151333033049", accName:"Priya Nair",                 role:"Internal Sales Agent", joined:"Mar 2023", status:"active",      accountStatus:"active",     spCount:8,  volume:187200, commission:1980.50, kpiMult:50,  kpiTarget:200000, kpiPct:93.6,  kpiPhase:"future"   },
    { id:"AG-0038", num:4,  referrer:true,  name:"Siti Rahimah",               mobile:"0193088813", email:"siti.rahimah@mylorry.ai", ic:"900611-05-5240", bankName:"Public Bank",  accNo:"3241880123",   accName:"Siti Rahimah Binti Aziz",    role:"Internal Sales Agent", joined:"Jun 2023", status:"active",      accountStatus:"inactive",   spCount:7,  volume:156800, commission:1654.00, kpiMult:50,  kpiTarget:200000, kpiPct:78.4,  kpiPhase:"complete" },
    { id:"AG-0055", num:5,  referrer:false, name:"Tan Wei Lin",                mobile:"0123456789", email:"tansuemei@gmail.com",      ic:"950110-10-6344", bankName:"Public Bank",  accNo:"162469343518", accName:"Tan Wei Lin",                role:"Internal Sales Agent", joined:"Nov 2024", status:"active",      accountStatus:"active",     spCount:4,  volume:98300,  commission:0,        kpiMult:0,   kpiTarget:200000, kpiPct:49.2,  kpiPhase:"active"   },
    { id:"AG-0067", num:6,  referrer:true,  name:"Raj Selvam",                 mobile:"0107899028", email:"raj@mylorry.ai",           ic:"851204-14-3598", bankName:"-",            accNo:"-",            accName:"-",                          role:"Internal Sales Agent", joined:"Feb 2025", status:"terminating", accountStatus:"terminated", spCount:3,  volume:61200,  commission:0,        kpiMult:0,   kpiTarget:200000, kpiPct:30.6,  kpiPhase:"complete" },
    { id:"AG-0071", num:7,  referrer:false, name:"Norafizah Binti Mohd Yasin", mobile:"0123456789", email:"norafizah@gmail.com",      ic:"801218-05-5240", bankName:"Maybank",      accNo:"151333033049", accName:"Norafizah Binti Mohd Yasin", role:"Internal Sales Agent", joined:"Mar 2024", status:"active",      accountStatus:"active",     spCount:5,  volume:122000, commission:1280.00, kpiMult:100, kpiTarget:120000, kpiPct:101.7, kpiPhase:"active"   },
    { id:"AG-0083", num:8,  referrer:true,  name:"Marcus Yong",                mobile:"0162173396", email:"marcusyong@mylorry.ai",    ic:"820609-05-5073", bankName:"-",            accNo:"-",            accName:"-",                          role:"Senior Agent",         joined:"Sep 2021", status:"active",      accountStatus:"active",     spCount:14, volume:298400, commission:3540.00, kpiMult:100, kpiTarget:240000, kpiPct:124.3, kpiPhase:"complete" },
    { id:"AG-0091", num:9,  referrer:false, name:"Cheah Kok Bin",              mobile:"0123040700", email:"max@maxador.com",          ic:"781008-08-6473", bankName:"Public Bank",  accNo:"6364296502",   accName:"Cheah Kok Bin",              role:"Internal Sales Agent", joined:"Dec 2023", status:"active",      accountStatus:"suspended",  spCount:6,  volume:143200, commission:1560.00, kpiMult:100, kpiTarget:150000, kpiPct:95.5,  kpiPhase:"active"   },
  ];

  const AGENT_CONFIG = {
    id:"AG-0042", num:1, name:"Kenneth Wang", role:"Internal Sales Agent",
